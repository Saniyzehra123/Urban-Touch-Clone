  ...
  return (
    <div className='signupcontainer'>
      ...
      <form className='signupinput '>
        <input  name="firstName"  type="text" placeholder="name" onChange={(e)=>{handleInput(e)}} className='detail' />
        
        <br />
        <input  name="lastName" type="text"  placeholder="name"  onChange={(e)=>{handleInput(e)}}className='detail' />
